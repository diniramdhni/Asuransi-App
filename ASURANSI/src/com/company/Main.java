    ...
    public static void addProspect(){
        ...
        do {
            try {
                ...
                tanggalLahir = LocalDate.parse(tglLahir, DateTimeFormatter.ofPattern("dd/MM/yyyy"));
                cek = true;
            }
            catch (Exception ex){
                System.out.println("Format tanggal salah! silakan input lagi");
                cek = false;
            }
        }while (cek == false);
    ...
    public static void ProspectToCustomer(){
        ...
        for (Prospect value : allprospect){
            if(value.getNoProspect() == inputprospect){
                ...
                System.out.print("Status KK (Kepala rumah tangga, Istri, atau Anak) : ");
                boolean cek = false;
                do {
                    String statuskk = scanner.nextLine();
                    if (statuskk.equalsIgnoreCase("kepala rumah tangga") ||
                            statuskk.equalsIgnoreCase("istri") ||
                            statuskk.equalsIgnoreCase("anak")) {
                        cek = true;
                    }
                    else {
                        System.out.println("harus Kepala rumah tangga, Istri, atau Anak!");
                        cek = false;
                    }
                }
                while (cek == false);
                ...
                nas.setNoNasabah(tanggalskrg.format(formattgl)+"/"+value.getNoProspect());
                nas.setNoKtp(ktp);
                if(statuskk.equalsIgnoreCase("kepala rumah tangga")){
                    nas.setStatusKk(StatusKK.KRT);
                }
                else if (statuskk.equalsIgnoreCase("istri")){
                    nas.setStatusKk(StatusKK.ISTRI);
                }
                else {
                    nas.setStatusKk(StatusKK.ANAK);
                }
    ...
    public static void  BuyProduct(){
        ...
        for(Nasabah value : allnasabah){
            if(inputnocus.equals(value.getNoNasabah())){
                ...
                System.out.println("Nasabah tidak ditemukkan!");
                BuyProduct();
            }
        }
