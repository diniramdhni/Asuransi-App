...
public class Nasabah {
    ...
    public Nasabah(String noNasabah, Long noKtp, String statusKk, String payMethod, Prospect prospect){
    ...
    public void summarynasabah(){
        System.out.println(String.format("No: %s, %s, %s, %s (%s), %s\n KTP: %d, Status di KK: %s, Payment Method: %s", this.noNasabah, this.prospect.getNamaDepan().concat(" ").concat(this.prospect.getNamaBelakang()),
                this.prospect.getJenisKelamin(), Main.formatTgl(this.prospect.getTglLahir()), this.prospect.getTempatLahir(), this.prospect.getPekerjaan(), this.noKtp, this.statusKk, this.payMethod));
    }
}
